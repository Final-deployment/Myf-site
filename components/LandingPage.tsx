        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {(initiatives.length > 0 ? initiatives : [
              { id: 'init_futuwwa', title: 'أكاديمية فتوة/فلسطين', description: 'بدأت العمل في فلسطين عام 2024م، وتهدف إلى ترسيخ القيم والأخلاق الإسلامية وتراعي عناصر الفتوة الخمسة: العلم، الأدب، الخدمة، الصحة، والحرفية.', image: '/logos/فتوة.png' },
              { id: 'init_ehdena', title: 'مبادرة اهدنا (على هدي الحبيب)', description: 'نشر تعاليم الدين الإسلامي من خلال الدورات ومجالس الذكر والصلاة على النبي الأسبوعية والشهرية بمساجد نابلس.', image: '/logos/على هدي الحبيب.png' },
              { id: 'init_meraj', title: 'مقرأة معراج', description: 'منصة تهدف لتحفيظ وتصحيح تلاوة القرآن الكريم بمسارين إلكتروني ووجاهي بمدرسة المسجد الحنبلي ببلدة نابلس القديمة.', image: '/logos/معراج.png' },
              { id: 'init_nabd_hayat', title: 'مبادرة نبض الحياة', description: 'تزويد الشباب والمتطوعين في المناطق عالية الخطورة بمهارات الإسعافات الأولية والاستجابة الطارئة برعاية محافظة نابلس.', image: '/logos/ نبض الحياة.png' },
              { id: 'init_nabd_aman', title: 'مبادرة نبض الأمان', description: 'تعزيز السلامة العامة وتدريب الشباب على التعامل مع حالات الطوارئ والإطفاء بالتعاون مع إطفائية نابلس والدفاع المدني.', image: '/logos/ نبض الأمان.png' },
              { id: 'init_basmat_amal', title: 'مبادرة بسمة أمل', description: 'دعم نفسي واجتماعي لتوعية المتدربين على التعامل مع المتأثرين بالصدمات وزيارة أطفال مرضى السرطان بمسشتفى النجاح.', image: '/logos/ بسمة أمل.png' }
            ]).map((init, i) => (
              <div 
                key={i} 
